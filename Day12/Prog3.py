...
while True:
    ...
    if choice == "1":
        ...
        if name == "":
            print("Student name cannot be empty or contain only spaces.")

        elif any(student.casefold() == name.casefold()
    ...
    # 3. Search student — case-insensitive
    elif choice == "3":
        name = input(
    ...
    # 4. Update student — case-insensitive
    elif choice == "4":
        old_name = input(
        ...
        if old_name == "":
            ...
            if found_index != -1:
                ...
                if new_name == "":
                    print(
                        "New name cannot be empty or contain only spaces."
                    )
    ...
    # 5. Delete student — case-insensitive
    elif choice == "5":
        name = input(
